                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?=url::to('@web/images/users/'.$admin->img)?>" class="user-image" alt="User Image">
                                <span class="hidden-xs">Alexander Pierce</span>
                            </a>
                            <ul class="dropdown-menu">

                                <li class="user-header">
                                    <img src="<?=url::to('@web/images/users/'.$admin->img)?>" class="img-circle" alt="User Image">
                                    <p>
                ...
                <!-- <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview menu-open">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="index-2.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
